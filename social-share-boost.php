...
function ssb_plugpage_links( $links,$plugin ) {
	if($plugin == plugin_basename(__FILE__))
	{
		...
		$links[] = '<a style="background: rgb(255, 169, 111);color: #442929;padding: 1px 4px;border-radius: 4px;font-weight: bold;font-size: 0.8em;" href="http://wordpress.org/plugins/sumome/" target="_blank">Upgrade with SumoMe</a>';
	}
	return $links;
}
