...
function ssb_output($upu,$ssb_artificial,$is_widget)
{
	...
	if($ssb_artificial['show_button_fb_like'])
	{
		$ssb_html.='<li class="fb';
		if($ssb_artificial['show_button_fb_share'])
			$ssb_html.='2';
		else
			$ssb_html.='1';
	...
	if($ssb_artificial['show_button_twtr'])
	{
	...
	if($ssb_artificial['show_button_gplus'])
	{
	...
	if($ssb_artificial['show_button_pintrest'])
	{
	...
	if($ssb_artificial['show_button_stumble'])
	{
	...
	if($ssb_artificial['show_button_tumblr'])
	{
	...
	if($ssb_artificial['show_button_linkedin'])
	{
