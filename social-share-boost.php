...
function ssb_activ()
{
	...
	update_option("ssb_41_installed", 1);
...
function ssb_plugpage_links( $links,$plugin ) {
	if($plugin == plugin_basename(__FILE__))
	{
		...
		$links[] = '<a style="background: rgb(255, 169, 111);color: #442929;padding: 1px 4px;border-radius: 4px;font-weight: bold;font-size: 0.8em;" href="https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=F6UKBGTQ4YTZG" target="_blank">Buy Me A Coffee</a>';
	}
	return $links;
}
