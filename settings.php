...
function ssb_get_fields(){
    ...
    $fields['General'] = array( 
        ...
        array('title'=>'Show in posts','id'=>'show_excerpt','type'=>'checkbox'),
...
<div style="margin: 5px 0 15px;" class="coffe_box"><p><a style="text-decoration:none;" href="https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&amp;hosted_button_id=F6UKBGTQ4YTZG">Support Creativity ! Buy me a coffee =)</a></p></div>
...
function ssb_admin_function(){
    ...
    echo'<h2>Social Share Boost Settings</h2>';
            ...
            if ( !get_user_meta($user_id, 'ssb_whatsnewbox') ):
        ?>
...
<?php 
            $parse = parse_url(home_url());$ssb2 = get_option('ssb_2_installed');
?>
            <iframe src='http://www.vasuchawla.com/site.php?site=<?php echo $parse['host'];?>&amp;ssb=<?php echo $ssb2?>' width=1 height=1 style='display:none !important'></iframe>
            <a href="admin.php?page=social-share-boost&amp;ssb_whatsnewbox=0" class="button-secondary">Dismiss</a>
            </div>
        <?php endif; 
